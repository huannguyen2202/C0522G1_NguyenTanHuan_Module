package ss15_text_file.exercise.copy_file_text;
...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        String fileIn = "src/ss15_text_file/exercise/copy_file_text/SourceFile.txt";
        String fileOut = "src/ss15_text_file/exercise/copy_file_text/TargetFile.txt";
