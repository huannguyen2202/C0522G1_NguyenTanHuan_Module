package ss9_dsa_List.exercise.method_of_arrayList.service.impl;
...
public class StudentService<E> implements IStudentService {
    ...
    static {
        ...
        people.add(new Student(1, "Thành"));
        people.add(new Student(2, "Huân"));
        people.add(new Student(3, "Bảo"));
        people.add(new Student(4, "Hùng"));
        people.add(new Student(5, "Ân"));
        people.add(new Student(6, "Đạt"));
